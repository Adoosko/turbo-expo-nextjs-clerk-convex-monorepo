    ...
    <div className="bg-primary">
      <div className="flex flex-wrap md:flex-nowrap justify-between container py-20 px-6 sm:px-0">
        <div className="max-w-[802px]">
          ...
          <Link href={"/notes"}>
            <button className="linear_gradient flex max-w-[438px] w-full justify-center items-center gap-2.5 px-8 py-4 rounded-[11px]  text-black text-xl sm:text-3xl not-italic font-semibold leading-[90.3%] tracking-[-0.75px]">
